...
Πριν ξεκινήσετε την εκμάθηση της <span style="color:coral">SELECT</span>, παρατηρήστε τα blocks που εμφανίζονται στο αριστερό μέρος της οθόνης.
...
<div
  ...
  data-answer-key="structure-before-select"
