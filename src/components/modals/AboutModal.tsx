    ...
    return (
        ...
        >
            <Modal.Header
                ...
                onClick={onHide}
            >
                <Modal.Title id="contained-modal-title-vcenter">Η ομάδα μας</Modal.Title>
            </Modal.Header>
                ...
                <Container style={{ overflow: 'auto' }}>
                    <div>
                        ...
                        <p>
                            ...
                            <br />
                            Δημήτριος Μάνος{' '}
                            <a href="mailto:jimman2003@hotmail.com" className="text-white ms-2">
                                <i className="bi bi-envelope-at-fill text-white"></i>
                            </a>
                            <br />
                        </p>
                        ...
                        <p>
                            {' '}
                            Γεράσιμος Χαριζάνης{' '}
                            <a href="mailto:gerasimoshari@gmail.com" className="text-white ms-2">
                                <i className="bi bi-envelope-at-fill text-white"></i>
                            </a>
                            <br />
                        </p>
                        ...
                        <p style={{ marginTop: '2%', marginBottom: '0%' }}>
                            <strong>
                                © 2023 <a href="https://sqlatch.michaelselvesakis.com">SQLatch</a>
                            </strong>
                        </p>
                    </div>
                </Container>
