...
export const LTS: LessonItem[] = [
    ...
    },
    {
        ...
        name: 'Φύλλο εργασίας με CREATE και INSERT',
        database: '',
        isScenario: false,
        requirements: [],
        numVideos: 0,
    ...
    {
        blocks: '',
        theory: 'Tasks/Tasks3/tasks.md',
        info: 'Άσκηση με SELECT και WHERE',
        name: 'Φύλλο εργασίας με WHERE',
        database: 'Lessons/Lesson1/database.db',
        isScenario: false,
        requirements: [],
        numVideos: 0,
    ...
    {
        blocks: 'Tasks/Tasks4/blocks.json',
        theory: 'Tasks/Tasks4/tasks.md',
        info: 'Άσκηση διόρθωσης συνθηκών με AND, OR, NOT',
        name: 'Φύλλο εργασίας με λογικούς τελεστές',
        database: 'Lessons/Lesson4/database.db',
        isScenario: false,
        requirements: [],
        numVideos: 0,
    ...
    },
    {
        ...
        name: 'Φύλλο εργασίας επανάληψης',
    ...
    {
        blocks: '',
        theory: 'Tasks/Tasks5/tasks.md',
        info: 'Άσκηση με ORDER BY, GROUP BY και HAVING',
        name: 'Φύλλο εργασίας με ORDER BY και GROUP BY',
        database: 'Lessons/Lesson9/database.db',
        isScenario: false,
        requirements: [],
        numVideos: 0,
    ...
    {
        blocks: '',
        theory: 'Tasks/Tasks6/tasks.md',
        info: 'Άσκηση με INNER JOIN',
        name: 'Φύλλο εργασίας με INNER JOIN',
        database: 'Lessons/Lesson10/database.db',
        isScenario: false,
        requirements: [],
        numVideos: 0,
