...
export default function Guide() {
    ...
    const LTS = ['Lessons/Lesson1/theory.md', 'Lessons/Lesson2/theory.md', 'Tasks/Tasks1/tasks.md', 'Scenarios/Scenario1/scen.md', 'Scenarios/Scenario2/scen2.md', 'Scenarios/Scenario3/scen3.md'];
    ...
    return (
        <Container fluid style={{ paddingLeft: 0, paddingRight: 0 }} className={styles.container}>
            <Pagination style={{ display: "flex", justifyContent: "center" }}>
                <Pagination.Item active={isPageActive(0)} onClick={() => setIdxState(0)}>Αρχική</Pagination.Item>
